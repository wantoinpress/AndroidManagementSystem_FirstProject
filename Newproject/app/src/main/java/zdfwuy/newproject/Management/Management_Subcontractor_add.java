...
public class Management_Subcontractor_add extends Activity {
    Button btn_sure,btn_cancel;
    EditText et_unitName,et_remarks,et_isUsed;
    String et_unitName_str,et_remarks_str,et_isUsed_str;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_management__subcontractor_add);
        InitEvent();
    }
        ...
        call.enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(Management_Subcontractor_add.this, "连接服务器失败！", Toast.LENGTH_SHORT).show();
                    }
                });
                e.printStackTrace();
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        if (status == 1) {
                            Toast.makeText(Management_Subcontractor_add.this, "添加成功", Toast.LENGTH_SHORT).show();
                            Intent intent = new Intent(Management_Subcontractor_add.this,Management_Subcontractor.class);
                            startActivity(intent);
                        } else {
                            Toast.makeText(Management_Subcontractor_add.this, "添加失败", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
