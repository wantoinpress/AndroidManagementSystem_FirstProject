...
public class Mydialog_subcontract_management extends Dialog {
    ...
    EditText EditText_rankNum,Editext_subcontractName,Edit_remarks,Edit_isUsed;
    ...
    public String getEditext_subcontractName_str() {
        return Editext_subcontractName_str;
    }

    public void setEditext_subcontractName_str(String editext_subcontractName_str) {
        Editext_subcontractName_str = editext_subcontractName_str;
    }
    ...
    private String EditText_rankNum_str;
    private String Editext_subcontractName_str;
    private String Edit_remarks_str;
    private String Edit_isUsed_str;
    public Mydialog_subcontract_management(@NonNull Context context,@StyleRes int theme) {
        super(context, theme);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mydialog_subcontract_management);
    ...
    public void  initview(){
     ...
     /* EditText_rankNum,Editext_constructionName,Edit_remarks,Edit_isUsed */
        ...
        Editext_subcontractName= (EditText) findViewById(R.id.Editext_subcontractName);
    ...
    private void initData() {
      ...
      /*EditText_rankNum_str,Editext_constructionName_str,Edit_remarks_str,Edit_isUsed_str*/
        ...
        if (Editext_subcontractName_str!=null){
            Editext_subcontractName.setText(Editext_subcontractName_str);
        }
 ...
 /*  Edit_isAbnormalIncome,Edit_isAbnormalMarginalProfit,Edit_isAbnormalMaterialCost; */
    ...
    public void SetEditTextnotENeditable(){
        ...
        Editext_subcontractName.setEnabled(false);
    ...
    public void SetEditTextENeditable(){
        ...
        Editext_subcontractName.setEnabled(true);
