...
public class Mydialog_performance extends Dialog {
    ...
    EditText EditText_rankNum,Editext_performanceName,Edit_remarks,Edit_isUsed;
    ...
    public String getEditext_performanceName_str() {
        return Editext_performanceName_str;
    }

    public void setEditext_performanceName_str(String editext_performanceName_str) {
        Editext_performanceName_str = editext_performanceName_str;
    }
    ...
    private String pid,EditText_rankNum_str,Editext_performanceName_str,Edit_remarks_str,Edit_isUsed_str;
    public Mydialog_performance(@NonNull Context context,@StyleRes int theme) {
        super(context, theme);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mydialog_performance);
    ...
    public void  initview(){
     ...
     /* EditText_rankNum,Editext_constructionName,Edit_remarks,Edit_isUsed */
        ...
        Editext_performanceName= (EditText) findViewById(R.id.Editext_performanceName);
    ...
    private void initData() {
      ...
      /*EditText_rankNum_str,Editext_constructionName_str,Edit_remarks_str,Edit_isUsed_str*/
        ...
        if (Editext_performanceName_str!=null){
            Editext_performanceName.setText(Editext_performanceName_str);
        }
 ...
 /*  Edit_isAbnormalIncome,Edit_isAbnormalMarginalProfit,Edit_isAbnormalMaterialCost; */
    ...
    public void SetEditTextnotENeditable(){
        ...
        Editext_performanceName.setEnabled(false);
    ...
    public void SetEditTextENeditable(){
        ...
        Editext_performanceName.setEnabled(true);
