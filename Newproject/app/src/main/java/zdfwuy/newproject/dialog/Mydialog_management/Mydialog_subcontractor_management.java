...
public class Mydialog_subcontractor_management extends Dialog {
    ...
    EditText Editext_unitName,Edit_remarks,Edit_isUsed;
    ...
    private  String pid,Editext_unitName_str,Edit_remarks_str,Edit_isUsed_str;

    public Mydialog_subcontractor_management(@NonNull Context context,@StyleRes int theme) {
        super(context, theme);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mydialog_subcontractor_management);
